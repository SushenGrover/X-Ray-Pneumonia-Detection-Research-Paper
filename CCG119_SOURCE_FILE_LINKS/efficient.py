...
# Freeze only the first 75% of the base model layers
trainable_layers = len(base_model.layers)
for layer in base_model.layers[:int(trainable_layers * 0.75)]:
...
# Save the Model
model.save("pneumonia_efficientnet_improved.h5")
print("\nModel saved as pneumonia_efficientnet_improved.h5")
